...
{   
	...
	public Color m_TargetScreenOverlayColor = new Color(0,0,0,0.4F);			// default target color: black and fully transparrent
	...
	public int m_FadeGUIDepth = 100;										// make sure this texture is drawn on top of everything
